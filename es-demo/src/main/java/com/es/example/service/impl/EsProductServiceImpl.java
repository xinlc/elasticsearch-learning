...
import com.es.example.dao.EsProductDao;
...
import com.es.example.repository.EsProductRepository;
import com.es.example.repository.ProductRepository;
...
//		List<EsProduct> esProductList = productList.stream().collect(ArrayList::new, (l, o) -> {
//			l.add(BeanUtil.copyProperties(o, EsProduct.class));
//		}, List::addAll);
